...
#### Overview
Data is captured in real time from the goodreads API using the Goodreads Python wrapper (View usage - [Fetch Data Module](https://github.com/Rehan018/goodReads/blob/main/example/fachdata.py)). The data collected from the goodreads API is stored on local disk and is timely moved to the Landing Bucket on AWS S3. ETL jobs are written in spark and scheduled in airflow to run every 10 minutes.  
...
Finally, copy the dag and plugin folder to EC2 inside airflow home directory. Also, checkout [Airflow Connection](https://github.com/Rehan018/goodReads/blob/main/docs/Airflow_Connections.md) for setting up connection to EMR and Redshift from Airflow.
...
![Pipeline DAG](https://github.com/Rehan018/goodReads/blob/main/docs/images/goodreads_dag.PNG)

DAG View:
![DAG View](https://github.com/Rehan018/goodReads/blob/main/docs/images/DAG.PNG)

DAG Tree View:
![DAG Tree](https://github.com/Rehan018/goodReads/blob/main/docs/images/DAG_tree_view.PNG)

DAG Gantt View: 
![DAG Gantt View](https://github.com/Rehan018/goodReads/blob/main/docs/images/DAG_Gantt.PNG)
...
![Source Dataset Count](https://github.com/Rehan018/goodReads/blob/main/docs/images/DatasetCount.PNG)


DAG Run Results:
![GoodReads DAG Run](https://github.com/Rehan018/goodReads/blob/main/docs/images/DAG_tree_view.PNG)

Data Loaded to Warehouse:
![GoodReads Warehouse Count](https://github.com/Rehan018/goodReads/blob/main/docs/images/WarehouseCount.PNG)
